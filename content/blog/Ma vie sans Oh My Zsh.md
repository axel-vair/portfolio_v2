...
head:
  meta:
    - name: 'Ma vie sans Oh my zsh'
      content: 'blog, apprentissage, langages, frameworks, ohmyzsh'
    - name: 'robots'
...
Par ailleurs, la génération à laquelle j’appartiens a été habituée à des packagings « recherchés », des designs léchés, aussi  parfois nous tombons dans le panneau et la forme prévaut sur le fond.
